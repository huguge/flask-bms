...
class UploadEbookForm(FlaskForm):
    ...
    description = TextAreaField(u'简短介绍',render_kw={'placeholder':'选填内容'})
...
class BookForm(FlaskForm):
    ...
    author = StringField(u'作者',render_kw={'placeholder':'选填内容'})
    publisher = StringField(u'出版社',render_kw={'placeholder':'选填内容'})
    book_number = StringField(u'编号',render_kw={'placeholder':'选填内容'})
    isbn = StringField(u'图书ISBN',render_kw={'placeholder':'选填内容'})
    tag = StringField(u'图书标签',render_kw={'placeholder':'请使用;分割不同的标签'})
